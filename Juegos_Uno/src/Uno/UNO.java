...
public class UNO {
    ...
    public static void main(String[] args) {
        ...
        Jugador[] jugadores = new Jugador[]{new Jugador("J1"), new Jugador("J2"), new Jugador("J3"), new Jugador("J4")};
        ...
        while(!juego.finJuego()) {
            ...
            while(!juego.finPartida()) {
                ...
                int indiceCarta = lectura.pedirIntRango(-1, juego.numCartasJugadorActual(), "Elige una carta de la mano, -1 para robar", "Solo numeros entre -1 y " + juego.numCartasJugadorActual());
                if (indiceCarta == -1) {
